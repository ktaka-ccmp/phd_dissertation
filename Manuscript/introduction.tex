...
In Chapter~\ref{chapter:Further Improvement} the performance level of the proposed load balancer is evaluated \added[id=2nd]{in 10Gbps network}.
...
The author clarifies the reasons for performance limitations \replaced[id=2nd]{of each of the results and shows that the proposed load balancer has sufficient throughput in 10Gbps network.}{ and discusses improvement.}
The author also proposes a novel software load balancer using eXpress Data Plane (XDP) technology \added[id=2nd]{for faster network} and presents preliminary experimental results.
