...
By using the proposed load balancer, the way to route traffic into container clusters is standardized, removing dependencies on load balancer architectures provided by infrastructures.
