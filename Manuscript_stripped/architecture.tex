...
1) Each node can accommodate multiple load balancer containers. This was not possible when \replaced[id=4th]{the author}{we} tried to directly connect load balancers and the router through SNAT.
