...
One of the most important problems of existing container orchestrators is that none of them has full support for the redundant and scalable ingress routing feature.
In order to sovle this problem the author proposes the a cluster of software load balancer in cntainers, which is deployed as a part of the web application clusters.
Key requirements for such load balancers are; 
