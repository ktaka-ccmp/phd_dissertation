...
\added{
As web applications become an essential part of daily life, improving their portabilities become very important.
...
\deleted{As web applications become an essential part of daily life,} \added{These days,} an outage of the web application service is getting to be a bigger problem.
...
\added{If the web cluster is portable, starting the service in a different country will be very easy.}
...
\replaced{Improving portability of}{ Therefore, being able to migrate } a web application cluster is \added{also} very important for \replaced{other}{ a variety of} purposes, including \deleted{disaster recovery, }cost performance optimizations, meeting legal compliance, and \replaced{avoiding vendor lock-in problems}{ shortening the geographical distance to customers}.
...
In this way, Kubernetes fails to provide uniformity\deleted{ that is essential for easy deployment and migration of complex}\added{ to improve portability of} web applications.
