...
To the best knowledge of the author, none of the existing container orchestrators \replaced[id=2nd]{fully support features that automatically set up ingress routing in a redundant and scalable manner.}{ has full support for the redundant and scalable ingress routing feature.}
