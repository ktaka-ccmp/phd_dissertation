...
\added{
As web applications become an essential part of daily life, their portabilities become very important.
If a web application cluster is portable, its provider can become being able to do a variety of things, for example, migrating the service when there is a disaster, expanding their business to different geographical locations, 
and preventing their services to be locked-in in a specific infrastructure.
}

\subsubsection{\added{Disaster Recovery:}}
...
\subsubsection{\added{Expansion of Bussiness:}}

\replaced{Portability}{Migration capability} of a web application cluster also has other benefits.
...
Therefore, \replaced{improving portability of}{ being able to migrate } a web application cluster is very important for a variety of purposes, including disaster recovery, cost performance optimizations, meeting legal compliance, and shortening the geographical distance to customers.
...
It is important for a web application provider to be able to easily deploy and migrate their web applications among different infrastructure around the world.
...
1) possessing universal middleware to manage web application clusters,
