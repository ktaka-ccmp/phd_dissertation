...
First overall architecure is explained in Section~\ref{poc_arch}.
Then ipvs containerization is explained in detail in Section~\ref{ipvs_cont}.
Finally implementation of BGP software container is explained in Section~\ref{bgp_cont}.

\section{Proof of concept system architecture}
