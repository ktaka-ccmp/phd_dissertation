...
The proxy daemon on the nodes also setup iptables DNAT \cite{MartinA.Brown2017} rules\added{ as a internal load balancer}. 
...
\replaced{If}{Suppose} there are 1,000 nodes and one of the web applications only uses 10 nodes, distributing the ingress traffic to all the 1,000 nodes seems inefficient and complicated.
