...
Multipling 270K [req/sec] with the response packet size 450[byte/req](Appendix~\ref{appendix:performance_limit}) and 8 [bit/byte] results in 972M [bit/sec] . }
...
From these results the author concludes the proposed load balancer is portable while providing 1.5 times better throughput than iptable DNAT.
