...
\added{
  As web applications become an essential part of daily life, improving their portabilities}\footnote{
    \added[id=2nd]{The author defines portability as the extent of easiness when making a web application interoperable in various infrastructures.}
  }\added{
 \replaced[id=2nd]{is getting to be}{become} very important \cite{opara2016critical,petcu2014portability}.
...
To the best knowledge of the author, none of the existing container orchestrators \replaced[id=2nd]{fully supports features that automatically set up ingress routing in a redundant and scalable manner.}{ has full support for the redundant and scalable ingress routing feature.}
