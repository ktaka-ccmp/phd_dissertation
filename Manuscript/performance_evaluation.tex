...
The author expects that replacing the benchmark client with more powerful machines, or changing the experimental setup so that multiple benchmark clients can simultaneouly perform the throughput measurements, will improve the performance level further.
