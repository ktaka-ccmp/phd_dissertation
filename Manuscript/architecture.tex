...
Since the upstream router normally has no knowledge of overlay network used in a Kubernet clusters, and hence IP addresses that containers use, a container must use SNAT to communicate with the router.
