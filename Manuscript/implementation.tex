...
Although in the actual production environment, proprietary hardware router with the highest throughput is usually deployed, one can still test some of the advanced features by using a conventionalLinux system as the router.
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|c|c|c|}
    ...
    \begin{tabular}{l} Static route advertisementr \end{tabular} & complex & simple & complex  \\ \hline
...
For example, in the case of gobgpd, after launching gobgpd, a user is required to issue a command line, e.g., \mytodo[inline]{change this with \enquote{gobgp global rib add -a ipv4 10.1.1.0/24 origin igp local-pref 10
}} \enquote{gobgp global rib add Service\_IP/32 origin igp nexthop Pod\_IP community 100:50 -a ipv4}.
