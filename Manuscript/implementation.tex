...
\begin{table}[H]
  ...
  \centering\parbox[c]{0.9\columnwidth}{
    OSS BGP agents are compared in terms of the features required in the proposed systems. \par
    \small
...
Table~\ref{table:bgp_agents} compares OSS BGP agents in terms of required features for the proposed architecture.
