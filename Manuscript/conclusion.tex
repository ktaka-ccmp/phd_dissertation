...
%
The throughput of the ipvs in container is equivalent to that of the iptables DNAT as a load balancer, in 1Gbps network environment.
...
The author leaves these for future work, however, a preliminary result of these has also been presented.
